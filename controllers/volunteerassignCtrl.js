...
"use strict";
angular.module('mjv')
.controller('VolunteerAssignCtrl', function ($scope, $timeout, $http,$cookies, Upload) {
        ...
        $scope.EditResquest = function(){
            ...
            $http.post('../MJV_SERVICES/services/services.php?q=editServiceRequest',$scope.data).then(function(response){
                if(response.data.type===1){
                 $http.get('../MJV_SERVICES/services/services.php?q=assignServiceRequests').then(function(response){
